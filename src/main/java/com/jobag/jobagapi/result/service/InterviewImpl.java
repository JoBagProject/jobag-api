package com.jobag.jobagapi.result.service;

import com.jobag.jobagapi.apply.domain.repository.JobOfferRepository;
import com.jobag.jobagapi.exception.ResourceNotFoundException;
import com.jobag.jobagapi.result.domain.model.Interview;
import com.jobag.jobagapi.result.domain.repository.InterviewRepository;
import com.jobag.jobagapi.result.domain.service.InterviewService;
    ...
    public Interview createInterview(Long postulantId, Long jobOfferId, Interview interview) {
        if (interviewRepository.existsByPostulantId(postulantId) && interviewRepository.existsByJobOfferId(jobOfferId))
            throw new ResourceNotFoundException(
                    "El postulante ya tiene programado una entrevista con la oferta de trabajo");
