package com.jobag.jobagapi.membership.domain.model;
...
public class PlanPostulant {
    ...
    public PlanPostulant(Long id, String description, int limit_postulations, int limit_videocreation,
            boolean pre_design_templates, int duration, Postulant postulant) {
        this.id = id;
