package com.jobag.jobagapi.membership.service;

import com.jobag.jobagapi.exception.ResourceNotFoundException;
import com.jobag.jobagapi.membership.domain.model.PlanPostulant;
import com.jobag.jobagapi.membership.domain.repository.PlanPostulantRepository;
import com.jobag.jobagapi.membership.domain.service.PlanPostulantService;
...
public class PlanPostulantServiceImpl implements PlanPostulantService {
    ...
    @Override
    public PlanPostulant updatePlanPostulant(Long postulantId, Long planpostulantId,
            PlanPostulant planpostulantDetails) {
